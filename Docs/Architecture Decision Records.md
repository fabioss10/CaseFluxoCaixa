...
### Decisão
Decidimos adotar o **UUIDv7** para todas as chaves primárias de transações. O UUIDv7 incorpora um componente de data/hora (*timestamp*) nos seus primeiros 48 bits, tornando-o naturalmente sequencial ao longo do tempo.
...
### Decisão
Decidimos definir a coluna **Data (`DateOnly`)** como a Chave Primária física da tabela `SaldosConsolidados`.
